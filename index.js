(() => {
      ...
      return function(f) {
        return function(ms) {
          return fold2(function(acc) {
            return function(k) {
              return function(v) {
                return apply3(map24(flip(insert(k)))(acc))(f(k)(v));
              };
            };
          })(pure15(empty))(ms);
        };
  ...
  var selectElement = function(query2) {
    return bind2(liftEffect3(bindFlipped5(composeKleisliFlipped4(function() {
  ...
  var getField3 = /* @__PURE__ */ getField2(/* @__PURE__ */ decodeArray2(decodeJsonString));
  ...
  var GetQuote = /* @__PURE__ */ function() {
    ...
    ;
    GetQuote2.value = new GetQuote2();
    return GetQuote2;
  }();
  var GetAllQuotes = /* @__PURE__ */ function() {
    function GetAllQuotes2() {
    }
    ;
    GetAllQuotes2.value = new GetAllQuotes2();
    return GetAllQuotes2;
  }();
  var render = function(state3) {
    return div_([h2_([text5("\u{1F4AC} Quote Explorer (Backend Powered)")]), p([style(function() {
      if (state3.isLoading) {
      ...
      if (state3.error instanceof Just) {
        return p([style("color: red; font-size: 0.9rem;")])([text5("Error: " + state3.error.value0)]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 74, column 7 - line 78, column 30): " + [state3.error.constructor.name]);
    }(), div_([button([onClick(function(v) {
      return GetQuote.value;
    }), disabled10(state3.isLoading)])([text5("\u2728 Get Random Quote")]), text5(" "), button([onClick(function(v) {
      return GetAllQuotes.value;
    }), disabled10(state3.isLoading), style("background-color: #4CAF50; margin-left: 10px;")])([text5("\u{1F4DA} Show All Quotes")])])]);
  };
  var decodeQuotesResponse = {
    decodeJson: function(json2) {
      return bind5(decodeJson2(json2))(function(obj) {
        return bind5(getField3(obj)("quotes"))(function(quotes) {
          return pure10({
            quotes
          });
        });
  ...
  var decodeJson1 = /* @__PURE__ */ decodeJson(decodeQuotesResponse);
  var decodeQuoteResponse = {
    decodeJson: function(json2) {
      return bind5(decodeJson2(json2))(function(obj) {
        return bind5(getField1(obj)("quote"))(function(quote) {
          return pure10({
            quote
          });
        });
  ...
  var decodeJson22 = /* @__PURE__ */ decodeJson(decodeQuoteResponse);
  var apiBaseUrl = "http://localhost:3001";
  var fetchAllQuotes = /* @__PURE__ */ function() {
    return bind15(get2(json)(apiBaseUrl + "/api/quotes"))(function(result) {
      if (result instanceof Left) {
        return pure14(new Left("Network error: " + printError(result.value0)));
      }
      ;
      if (result instanceof Right) {
        var v = decodeJson1(result.value0.body);
        if (v instanceof Left) {
          return pure14(new Left("JSON decode error: " + show4(v.value0)));
        }
        ;
        if (v instanceof Right) {
          return pure14(new Right(v.value0.quotes));
        }
        ;
        throw new Error("Failed pattern match at Main (line 117, column 7 - line 119, column 65): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 114, column 3 - line 119, column 65): " + [result.constructor.name]);
    });
  }();
  var fetchRandomQuote = /* @__PURE__ */ function() {
    return bind15(get2(json)(apiBaseUrl + "/api/quote"))(function(result) {
      if (result instanceof Left) {
        return pure14(new Left("Network error: " + printError(result.value0)));
      }
      ;
      if (result instanceof Right) {
        ...
        ;
        if (v instanceof Right) {
          return pure14(new Right(v.value0.quote));
        }
        ;
        throw new Error("Failed pattern match at Main (line 106, column 7 - line 108, column 62): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 103, column 3 - line 108, column 62): " + [result.constructor.name]);
    });
  }();
  var handleAction = function(v) {
    if (v instanceof GetQuote) {
      return discard5(modify_3(function(st) {
        ...
        ;
        $52.isLoading = true;
        $52.error = Nothing.value;
        return $52;
      }))(function() {
        return bind22(liftAff2(fetchRandomQuote))(function(result) {
          if (result instanceof Left) {
            return modify_3(function(st) {
              ...
              ;
              $56.isLoading = false;
              $56.error = new Just(result.value0);
              return $56;
            });
          }
          ;
          if (result instanceof Right) {
            return modify_3(function(st) {
              ...
              ;
              $60.quote = result.value0;
              $60.isLoading = false;
              $60.error = Nothing.value;
              return $60;
            });
          }
          ;
          throw new Error("Failed pattern match at Main (line 126, column 3 - line 128, column 93): " + [result.constructor.name]);
        });
      });
    }
    ;
    if (v instanceof GetAllQuotes) {
      return discard5(modify_3(function(st) {
        var $64 = {};
        for (var $65 in st) {
        ...
        ;
        $64.isLoading = true;
        $64.error = Nothing.value;
        return $64;
      }))(function() {
        return bind22(liftAff2(fetchAllQuotes))(function(result) {
          if (result instanceof Left) {
            return modify_3(function(st) {
              var $68 = {};
              for (var $69 in st) {
              ...
              ;
              $68.isLoading = false;
              $68.error = new Just(result.value0);
              return $68;
            });
          }
          ;
          if (result instanceof Right) {
            var allQuotesText = "All available quotes:\n\n" + joinWith("\n")(map23(function(q2) {
              return "\u2022 " + q2;
            })(result.value0));
            return modify_3(function(st) {
              var $72 = {};
              ...
              ;
              $72.quote = allQuotesText;
              $72.isLoading = false;
              $72.error = Nothing.value;
              return $72;
            });
          }
          ;
          throw new Error("Failed pattern match at Main (line 133, column 3 - line 137, column 91): " + [result.constructor.name]);
        });
      });
    }
    ;
    throw new Error("Failed pattern match at Main (line 122, column 1 - line 122, column 67): " + [v.constructor.name]);
  };
  var component = /* @__PURE__ */ function() {
    return mkComponent({
      initialState: $$const({
        quote: "Click the button to get a quote from the server!",
        isLoading: false,
        error: Nothing.value
      }),
      render,
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind15(awaitBody)(function() {
    return bind15(selectElement("#app"))(function(app) {
      if (app instanceof Just) {
        return $$void7(runUI2(component)(unit)(app.value0));
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 144, column 3 - line 146, column 25): " + [app.constructor.name]);
    });
  }));
